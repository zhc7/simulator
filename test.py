...
Box = Entity(InnerCircle(10), 1, np.array([0, 0], dtype="float32"), 0, 0, fixed=True)
...
c4 = Entity(Circle(1), 2, np.array([-10, 10], dtype="float32"), np.array([0, 0], dtype="float32"), 0)


world = World([Box, c4, c1, c2, c3], {"g": np.array([0, 0])})
